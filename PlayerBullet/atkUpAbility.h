...
#include "AtkUpDecorator.h"
#include "../decoratorManager.h"

class AtkUpAbility : public BulletAbility
{
public:
	Bullet* Apply(Bullet* bullet) override {
		AtkUpDecorator* decorator = DecoratorManager::AccessAtkUpDecorator();
	...
	void Init() override
	{
		...
		LoadFromWICFile(L"asset\\texture\\AttackIcon.png", WIC_FLAGS_NONE, &metadata, image);
