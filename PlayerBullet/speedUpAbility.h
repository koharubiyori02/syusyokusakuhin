...
class SpeedUpAbility : public BulletAbility
{
public:
	Bullet* Apply(Bullet* bullet) override {
		SpeedUpDecorator* decorator = DecoratorManager::AccessSpeedUpDecorator();
	...
	void Init() override
	{
		...
		LoadFromWICFile(L"asset\\texture\\SpeedUpIcon.png", WIC_FLAGS_NONE, &metadata, image);
