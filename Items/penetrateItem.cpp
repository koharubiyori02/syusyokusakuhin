...
void PenetrateItem::Init()
{
	...
	AddComponent<ParticleEmitterItem>()->SetColor(XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f));

	m_Scale = XMFLOAT3(0.1f, 0.1f, 0.1f);
}

void PenetrateItem::Uninit()
{
...
void PenetrateItem::Update()
{
	GetComponent<ParticleEmitterItem>()->Update();//アイテムのパーティクルの更新
}

void PenetrateItem::Draw()
{
