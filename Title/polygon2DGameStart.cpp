#include "..//main.h"
#include "..//renderer.h"
#include "polygon2DGameStart.h"
#include "..//ImGUI/imgui.h"
#include "..//manager.h"
#include "..//Particle//particleTitleSelect.h"

void Polygon2DGameStart::Init()
{
	VERTEX_3D vertex[4];
	vertex[0].Position = XMFLOAT3(850.0f, 350.0f, 0.0f);
	vertex[0].Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
	vertex[0].Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[0].TexCoord = XMFLOAT2(0.0f, 0.0f);

	vertex[1].Position = XMFLOAT3(1050.0f, 350.0f, 0.0f);
	vertex[1].Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
	vertex[1].Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = XMFLOAT2(1.0f, 0.0f);

	vertex[2].Position = XMFLOAT3(850.0f, 450.0f, 0.0f);
	vertex[2].Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
	vertex[2].Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = XMFLOAT2(0.0f, 1.0f);

	vertex[3].Position = XMFLOAT3(1050.0f, 450.0f, 0.0f);
...
void Polygon2DGameStart::Uninit()
{
...
void Polygon2DGameStart::Update()
{

}

void Polygon2DGameStart::Draw()
{
	...
	if (select->GetTitleSelect() == TitleSelect::START)
	{
		//シェーダー設定
...
void Polygon2DGameStart::ImGuiDebug()
{
	//頂点データ書き換え
